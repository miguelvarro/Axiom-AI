...
from axiom_ai.app.api.schemas.answer import Methodology
from axiom_ai.app.api.schemas.answer import Methodology
from axiom_ai.core.domain.paper import Paper
from axiom_ai.core.ranking.reranker import rerank_hits
from axiom_ai.core.ranking.semantic_reranker import SemanticReranker
from axiom_ai.core.reasoning.evidence_extractor import extract_evidence_spans
from axiom_ai.core.retrieval.online import OnlinePaperRetriever
from axiom_ai.utils.text import clean_text
from axiom_ai.core.reasoning.prompt_loader import load_prompt
from axiom_ai.core.reasoning.stance_classifier import classify_papers_stances
from axiom_ai.core.reasoning.llm_client import LLMClient
from axiom_ai.core.reasoning.query_analyzer import analyze_query
from axiom_ai.core.reasoning.confidence import compute_confidence_score

from axiom_ai.core.reasoning.aggregation import (
    aggregate_weighted_stances,
)

from axiom_ai.core.reasoning.presentation import (
    build_consensus_api_output,
)

try:
    from axiom_ai.core.reasoning.llm_client import (
...
class AnswerService:
    ...
    def __init__(
        self,
        online_retriever: Optional[
            OnlinePaperRetriever
        ] = None,
    ):
        self.online_retriever = (
            online_retriever
            or OnlinePaperRetriever()
        )
    ...
    def answer(
        ...
        if not hits:
            ...
            return {
                ...
                "consensus_label": "insufficient_evidence",
                "dominant_stance": "neutral",
                "top_papers": [],
                "supporting_evidence": [],
